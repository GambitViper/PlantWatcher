...
namespace ImagineCupBTrees.Controllers
{
    public class PlantgroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PlantName,AutoDeviceManagement")] Plantgroup plantgroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PlantName,AutoDeviceManagement")] Plantgroup plantgroup)
        {
            if (ModelState.IsValid)
            {
